...
${OBJECTDIR}/ARBVC.o: ARBVC.cpp 
	${MKDIR} -p ${OBJECTDIR}
	${RM} "$@.d"
	$(COMPILE.cc) -g -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/ARBVC.o ARBVC.cpp
...
${OBJECTDIR}/GreedyVC.o: GreedyVC.cpp 
	${MKDIR} -p ${OBJECTDIR}
	${RM} "$@.d"
	$(COMPILE.cc) -g -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/GreedyVC.o GreedyVC.cpp

${OBJECTDIR}/IPLVC.o: IPLVC.cpp 
	${MKDIR} -p ${OBJECTDIR}
	${RM} "$@.d"
	$(COMPILE.cc) -g -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/IPLVC.o IPLVC.cpp

${OBJECTDIR}/KernelVC.o: KernelVC.cpp 
	${MKDIR} -p ${OBJECTDIR}
	${RM} "$@.d"
	$(COMPILE.cc) -g -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/KernelVC.o KernelVC.cpp
...
${OBJECTDIR}/SetGraph.o: SetGraph.cpp 
	${MKDIR} -p ${OBJECTDIR}
	${RM} "$@.d"
	$(COMPILE.cc) -g -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/SetGraph.o SetGraph.cpp

${OBJECTDIR}/VC.o: VC.cpp 
	${MKDIR} -p ${OBJECTDIR}
	${RM} "$@.d"
	$(COMPILE.cc) -g -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/VC.o VC.cpp
