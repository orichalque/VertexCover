...
${OBJECTDIR}/AVC.o: AVC.cpp 
	${MKDIR} -p ${OBJECTDIR}
	${RM} "$@.d"
	$(COMPILE.cc) -g -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/AVC.o AVC.cpp
...
${OBJECTDIR}/VertexCoverAbstract.o: VertexCoverAbstract.cpp 
	${MKDIR} -p ${OBJECTDIR}
	${RM} "$@.d"
	$(COMPILE.cc) -g -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/VertexCoverAbstract.o VertexCoverAbstract.cpp

${OBJECTDIR}/VertexCoverAbstractStruct.o: VertexCoverAbstractStruct.cpp 
	${MKDIR} -p ${OBJECTDIR}
	${RM} "$@.d"
	$(COMPILE.cc) -g -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/VertexCoverAbstractStruct.o VertexCoverAbstractStruct.cpp
